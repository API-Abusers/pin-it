...
public final class LocationRow: OptionsRow<PushSelectorCell<CLLocation>>, PresenterRowType, RowType {
    ...
    public typealias PresenterRow = EmbeddedMapViewController
    ...
    public required init(tag: String?) {
        super.init(tag: tag)
        presentationMode = .show(controllerProvider: ControllerProvider.callback { return EmbeddedMapViewController(){ _ in } }, onDismiss: { vc in _ = vc.navigationController?.popViewController(animated: true) })
...
public class EmbeddedMapViewController : UIViewController, TypedRowControllerType, MKMapViewDelegate {
